...
thumbnail: /images/temporal_model.png
objective: "Investigate which Machine Learning (or Deep Learning) algorithms would benefit the area of strong-field QED."
works: '<ol class="part1" class="archive__item-research-excerpt">
	<li><b>M. Valialshchikov</b>, A. Saevert, M. Zepf, “Spatial laser jitter prediction with neural networks”: time series prediction on temporal and short-time Fourier transform features with fast inference and decent prediction quality. Tested architectures vary from basic RNNs to probabilistic forecasters (e.g. Autoformer), 2023-2025 <br> 
